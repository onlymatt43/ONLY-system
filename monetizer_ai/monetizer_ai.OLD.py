...
# Créer le dossier parent si nécessaire (pour SQLite local)
if not TURSO_URL:
...
# Import Turso client si disponible
...
def db():
    """Return a database connection (SQLite or Turso)"""
    global _turso_client
    if USE_TURSO:
        if not _turso_client:
